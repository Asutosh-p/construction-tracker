...
/**
 * Auto-generated Building Routes
 *
...
import type { BuildingHooks } from "./building.hooks"
...
/**
 * Set hooks for Building routes
 */
export function setBuildingHooks(h: BuildingHooks) {
  hooks = h
}
...
const WRITABLE_SCALAR_FIELDS = ["name", "buildingTypeId", "createdAt", "updatedAt"] as const
const RELATION_FIELDS = ["buildingType", "floors"] as const
...
/**
 * Create Building CRUD routes
 */
export function createBuildingRoutes(): Hono {
  ...
  router.get("/:id", async (c) => {
    try {
      ...
      if (!item) {
        return sendJson(c, { error: { code: "not_found", message: "Building not found" } }, 404)
      }
