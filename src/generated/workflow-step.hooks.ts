...
/**
 * Hooks for WorkflowStep routes
 */
export interface WorkflowStepHooks {
  /**
...
/**
 * Default WorkflowStep hooks (customize as needed)
 */
export const workflowStepHooks: WorkflowStepHooks = {
