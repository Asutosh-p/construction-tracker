...
/**
 * Hooks for BuildingType routes
 */
export interface BuildingTypeHooks {
  /**
...
/**
 * Default BuildingType hooks (customize as needed)
 */
export const buildingTypeHooks: BuildingTypeHooks = {
