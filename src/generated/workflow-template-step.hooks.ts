...
/**
 * Hooks for WorkflowTemplateStep routes
 */
export interface WorkflowTemplateStepHooks {
  /**
...
/**
 * Default WorkflowTemplateStep hooks (customize as needed)
 */
export const workflowTemplateStepHooks: WorkflowTemplateStepHooks = {
