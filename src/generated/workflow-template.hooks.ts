...
/**
 * Hooks for WorkflowTemplate routes
 */
export interface WorkflowTemplateHooks {
  /**
...
/**
 * Default WorkflowTemplate hooks (customize as needed)
 */
export const workflowTemplateHooks: WorkflowTemplateHooks = {
