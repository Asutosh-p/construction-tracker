...
var chunk_WS75TKHZ_exports = {};
__export(chunk_WS75TKHZ_exports, {
  GetDmmfError: () => GetDmmfError,
  getDMMF: () => getDMMF
});
module.exports = __toCommonJS(chunk_WS75TKHZ_exports);
var import_chunk_WSZXPLJQ = require("./chunk-WSZXPLJQ.js");
var import_chunk_R6QH57HZ = require("./chunk-R6QH57HZ.js");
var import_chunk_PHSZERBB = require("./chunk-PHSZERBB.js");
...
[Context: getDmmf]`;
    super((0, import_chunk_PHSZERBB.addVersionDetailsToErrorMessage)(errorMessageWithContext));
  ...
  const dmmfPipeline = (0, import_function.pipe)(
    (0, import_chunk_5DBOS77Y.tryCatch)(
      () => {
        ...
        const data = import_chunk_HXMDA5QL.prismaSchemaWasm.get_dmmf(params);
        return data;
      },
      (e) => ({
        type: "wasm-error",
