...
}>({ value: '', onValueChange: () => {}, open: false, setOpen: () => {}, labels: {}, registerLabel: () => {} })
...
export function Select({ value: controlledValue, defaultValue = '', onValueChange, children }: SelectProps) {
  ...
  return (
    <SelectContext.Provider value={{ value, onValueChange: handleChange, open, setOpen, labels, registerLabel }}>
...
export function SelectValue({ placeholder }: { placeholder?: string }) {
  ...
  return <span className={cn(!value && 'text-muted-foreground')}>{display || placeholder}</span>
}
