...
/**
 * Hooks for RoomItemTemplate routes
 */
export interface RoomItemTemplateHooks {
  /**
...
/**
 * Default RoomItemTemplate hooks (customize as needed)
 */
export const roomItemTemplateHooks: RoomItemTemplateHooks = {
